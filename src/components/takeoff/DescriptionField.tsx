    ...
    <div ref={containerRef} className="relative">
      <div className="flex gap-2 rounded-lg border border-[#D9D9D9] bg-white px-3 py-3">
        ...
        <textarea
          ...
          rows={3}
          className="w-full text-sm font-semibold text-black leading-relaxed bg-transparent border-none outline-none resize-none placeholder:text-gray-400 placeholder:font-normal"
        />
      </div>
